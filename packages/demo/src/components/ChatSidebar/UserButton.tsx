    ...
    >
      <div
        className={cls`rounded-full p-1 w-8 h-8 flex items-center justify-center
                      font-serif text-xl mr-4 bg-gray-200 font-bold text-gray-600`}
      >
      ...
      <div className={cls`flex flex-col w-min items-start overflow-hidden`}>
        ...
        <p
          className={cls`text-sm text-gray-600 overflow-ellipsis overflow-hidden whitespace-nowrap flex-1`}
        >
